...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            <!-- error alert -->
            <?= form_error('menu', '<div class="alert alert-danger" style="margin-top:-17px;" role="alert">', '</div>'); ?>
            <!-- success alert -->
                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('menu/deleteMenu/') . $r['id'] ?>" class="btn btn-danger btn-sm">delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
